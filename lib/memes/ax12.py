...
class Ax12:
    ...
    def ping(self,id):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_READ_DATA)
        outData.append(Ax12.AX_PING)
    ...
    def factoryReset(self,id, confirm = False):
        if(confirm):
            ...
            outData.append(Ax12.AX_START)
            outData.append(id)
            outData.append(Ax12.AX_RESET_LENGTH)
            outData.append(Ax12.AX_RESET)
            outData.append(checksum)
            Ax12.port.write(outData)
            sleep(Ax12.TX_DELAY_TIME)
            return self.readData(id)
    ...
    def setID(self, id, newId):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_ID_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_ID)
        outData.append(newId)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
        return self.readData(id)
    ...
    def setBaudRate(self, id, baudRate):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_BD_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_BAUD_RATE)
        outData.append(br)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def setStatusReturnLevel(self, id, level):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_SRL_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_RETURN_LEVEL)
        outData.append(level)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
        return self.readData(id)
    ...
    def setReturnDelayTime(self, id, delay):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_RDT_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_RETURN_DELAY_TIME)
        outData.append((int(delay)/2)&0xff)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
        return self.readData(id)
    ...
    def lockRegister(self, id):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_LR_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_LOCK)
        outData.append(Ax12.AX_LOCK_VALUE)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
        return self.readData(id)
    ...
    def move(self, id, position):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_GOAL_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_GOAL_POSITION_L)
        outData.append(p[0])
        outData.append(p[1])
        outData.append(checksum)
        Ax12.port.write(outData)
    ...
    def moveSpeed(self, id, position, speed):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_GOAL_SP_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_GOAL_POSITION_L)
        outData.append(p[0])
        outData.append(p[1])
    ...
    def moveRW(self, id, position):
        ...
        outData.append(id)
        outData.append(Ax12.AX_GOAL_LENGTH)
        outData.append(Ax12.AX_REG_WRITE)
        outData.append(Ax12.AX_GOAL_POSITION_L)
        outData.append(p[0])
        outData.append(p[1])
        outData.append(checksum)
    ...
    def action(self):
        ...
        outData.append(Ax12.AX_START)
        outData.append(Ax12.AX_START)
        outData.append(Ax12.AX_BROADCAST_ID)
        outData.append(Ax12.AX_ACTION_LENGTH)
        outData.append(Ax12.AX_ACTION)
        outData.append(Ax12.AX_ACTION_CHECKSUM)
        Ax12.port.write(outData)
        #sleep(Ax12.TX_DELAY_TIME)
    ...
    def setTorqueStatus(self, id, status):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_TORQUE_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_TORQUE_STATUS)
        outData.append(ts)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def setLedStatus(self, id, status):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_LED_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_LED_STATUS)
        outData.append(ls)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def setTemperatureLimit(self, id, temp):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_TL_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_LIMIT_TEMPERATURE)
        outData.append(temp)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def setVoltageLimit(self, id, lowVolt, highVolt):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_VL_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_DOWN_LIMIT_VOLTAGE)
        outData.append(lowVolt)
        outData.append(highVolt)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
        return self.readData(id)
    ...
    def setAngleLimit(self, id, cwLimit, ccwLimit):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_AL_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_CW_ANGLE_LIMIT_L)
        outData.append(cw[0])
        outData.append(cw[1])
        outData.append(ccw[0])
        outData.append(ccw[1])
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
        return self.readData(id)
    ...
    def setTorqueLimit(self, id, torque):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_MT_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_MAX_TORQUE_L)
        outData.append(mt[0])
        outData.append(mt[1])
        outData.append(checksum)
        Ax12.port.write(outData)
    ...
    def setPunchLimit(self, id, punch):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_PUNCH_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_PUNCH_L)
        outData.append(p[0])
        outData.append(p[1])
        outData.append(checksum)
        Ax12.port.write(outData)
    ...
    def setCompliance(self, id, cwMargin, ccwMargin, cwSlope, ccwSlope):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_COMPLIANCE_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_CW_COMPLIANCE_MARGIN)
        outData.append(cwMargin)
        outData.append(ccwMargin)
        outData.append(cwSlope)
        outData.append(ccwSlope)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
        return self.readData(id)
    ...
    def setLedAlarm(self, id, alarm):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_LEDALARM_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_ALARM_LED)
        outData.append(alarm)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
        return self.readData(id)
    ...
    def setShutdownAlarm(self, id, alarm):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_SHUTDOWNALARM_LENGTH)
        outData.append(Ax12.AX_WRITE_DATA)
        outData.append(Ax12.AX_ALARM_SHUTDOWN)
        outData.append(alarm)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def readTemperature(self, id):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_TEM_LENGTH)
        outData.append(Ax12.AX_READ_DATA)
        outData.append(Ax12.AX_PRESENT_TEMPERATURE)
        outData.append(Ax12.AX_BYTE_READ)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
        return self.readData(id)
    ...
    def readPosition(self, id):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_POS_LENGTH)
        outData.append(Ax12.AX_READ_DATA)
    ...
    def readVoltage(self, id):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_VOLT_LENGTH)
        outData.append(Ax12.AX_READ_DATA)
        outData.append(Ax12.AX_PRESENT_VOLTAGE)
        outData.append(Ax12.AX_BYTE_READ)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def readSpeed(self, id):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_SPEED_LENGTH)
        outData.append(Ax12.AX_READ_DATA)
        outData.append(Ax12.AX_PRESENT_SPEED_L)
        outData.append(Ax12.AX_INT_READ)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def readLoad(self, id):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_LOAD_LENGTH)
        outData.append(Ax12.AX_READ_DATA)
        outData.append(Ax12.AX_PRESENT_LOAD_L)
        outData.append(Ax12.AX_INT_READ)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def readMovingStatus(self, id):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_MOVING_LENGTH)
        outData.append(Ax12.AX_READ_DATA)
        outData.append(Ax12.AX_MOVING)
        outData.append(Ax12.AX_BYTE_READ)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def readRWStatus(self, id):
        ...
        outData.append(Ax12.AX_START)
        outData.append(id)
        outData.append(Ax12.AX_RWS_LENGTH)
        outData.append(Ax12.AX_READ_DATA)
        outData.append(Ax12.AX_REGISTERED_INSTRUCTION)
        outData.append(Ax12.AX_BYTE_READ)
        outData.append(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def learnServos(self,maxCount, minValue=1, maxValue=254, verbose=False) :
        servoList = []
        print("Learning servos")
        for i in range(minValue, maxValue + 1):
            try :
                temp = self.ping(i)
                servoList.append(i)
                if len(servoList) >= maxCount:
                    break
                if verbose: 
